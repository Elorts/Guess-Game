...
class QuizInterface:
    ...
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.yes_button = Button(command=self.true_pressed, image=yes_image, highlightthickness=0)
        self.yes_button.grid(column=0, row=2)

        self.no_button = Button(command=self.false_pressed, image=no_image, highlightthickness=0)
